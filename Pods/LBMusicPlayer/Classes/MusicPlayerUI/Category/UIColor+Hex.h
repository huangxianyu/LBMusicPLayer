...
//  SimpleEditor
//
//  Created by 黄贤于 on 16/5/25.
//  Copyright © 2016年 黄贤于. All rights reserved.
//
...
#define SXRGB16ColorAlpha(rgbValue,a) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:(a)]
 ...
 *  从十六进制字符串获取颜色
 *
 *  @param color 字符串 支持 @"#123456"、@"0X123456"、@"123456" 三种格式中获取颜色值
 *
 *  @return UIColor
 */
